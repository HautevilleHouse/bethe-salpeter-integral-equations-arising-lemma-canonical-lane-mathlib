...
def sourceRepository : String := "bethe-salpeter-integral-equations-arising-lemma"
def sourceDescription : String := "Bethe Salpeter Integral Equations Arising Lemma"

def sourceTheoremBoundary : SourceTheoremBoundary := {
  claimBoundary := "classical boundary of Bethe Salpeter integral equations"
}
